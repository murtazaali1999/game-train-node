...
const {Program, Provider, web3, utils,Wallet} = require("@project-serum/anchor");
...
module.exports  = {
    ...
    const airDropSig = await connection.requestAirdrop(keypair.publicKey,2000000000).catch((err)=>{
